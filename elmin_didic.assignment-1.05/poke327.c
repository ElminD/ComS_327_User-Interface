...
void battle()
{
    int input;
    clear();
    mvprintw(0,0,"A Battle has begun!");
...
void list_trainers()
{
    ...
    int player_x = world.pc.pos[dim_x];
    int player_y = world.pc.pos[dim_y];
        ...
        for(x = 0; x < MAP_X; x++) {
            if(world.cur_map->cmap[y][x]) {
                if(world.cur_map->cmap[y][x]->symbol == '@') {
                    ...
                    distance_x = x - player_x;
                    distance_y = y - player_y;
                    if(distance_x < 0) {
...
static void print_map()
{
  ...
  for (y = 0; y < MAP_Y; y++) {
    for (x = 0; x < MAP_X; x++) {
      if (world.cur_map->cmap[y][x]) {
          mvaddch(y + 3, x, world.cur_map->cmap[y][x]->symbol);
      } else {
          ...
          while(valid == 0) {
              ...
              switch (input) {
                  ...
                  case 'y':
                      ...
                      else if(move_cost[char_pc][world.cur_map->map[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x] - 1]] != INT_MAX && world.cur_map->cmap[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x] - 1]->is_dead == 0) {
                          battle();
                          world.cur_map->cmap[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x] - 1]->is_dead = 1;
                      }
                      pathfind(world.cur_map);
                      valid = 1;
                      break;
                  ...
                  case 'k':
                      ...
                      else if(move_cost[char_pc][world.cur_map->map[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x]]] != INT_MAX && world.cur_map->cmap[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x]]->is_dead == 0) {
                          battle();
                          world.cur_map->cmap[world.pc.pos[dim_y] - 1][world.pc.pos[dim_x]]->is_dead = 1;
                      }
                      pathfind(world.cur_map);
                      valid = 1;
                      break;
                  ...
                  case 'l':
                      ...
                      else if(move_cost[char_pc][world.cur_map->map[world.pc.pos[dim_y]][world.pc.pos[dim_x] + 1]] != INT_MAX && world.cur_map->cmap[world.pc.pos[dim_y]][world.pc.pos[dim_x] + 1]->is_dead == 0) {
                          battle();
                          world.cur_map->cmap[world.pc.pos[dim_y]][world.pc.pos[dim_x] + 1]->is_dead = 1;
                      }
                      pathfind(world.cur_map);
                      valid = 1;
                      break;
